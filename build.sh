...
make image  PROFILE="$buildProfile" PACKAGES="luci luci-app-sqm luci-app-ddns dnscrypt-proxy -wpad-basic-wolfssl wpad-wolfssl hostapd-utils" FILES="../../filesystem/" BIN_DIR="$binfolder"
#make clean
popd>/dev/null
